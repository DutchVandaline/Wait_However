...
class HomeScreen_URLONLY extends StatefulWidget {
  @override
  _HomeScreen_URLONLYState createState() => _HomeScreen_URLONLYState();
}

class _HomeScreen_URLONLYState extends State<HomeScreen_URLONLY> {
  ...
  void initState() {
    ...
    // Listen for shared media when the app is in memory
    _intentSub = ReceiveSharingIntent.instance.getMediaStream().listen(
        (List<SharedMediaFile> value) {
      if (value.isNotEmpty) {
        // Check for potential URLs in the `path` of the shared file
